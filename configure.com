...
$ WC "d_get_current_dir_name='undef'"
...
$ WC "devtype='" + devtype + "'"
$ WC "default_inc_excludes_dot='define'"
$ WC "direntrytype='struct dirent'"
$ WC "dlext='" + dlext + "'"
$ WC "dlobj='" + dlobj + "'"
$ WC "dl_so_eq_ext='define'"
$ WC "dlsrc='dl_vms.xs'"
$ WC "doublekind='3'"
...
$ WC "i_netinet_in_systm='undef'"
$ WC "i_netinet_ip='undef'"
$ WC "i_netinet_ip6='undef'"
$ WC "i_niin='" + i_niin + "'"
$ WC "i_poll='" + i_poll + "'"
$ WC "i_prot='undef'"
$ WC "i_pthread='define'"
