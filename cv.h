...
#define CVf_LINEARIZED 0x1000000 /* optimized oparray */
...
#define CvLINEARIZED(cv)	(CvFLAGS(cv) & CVf_LINEARIZED)
#define CvLINEARIZED_on(cv)	(CvFLAGS(cv) |= CVf_LINEARIZED)
