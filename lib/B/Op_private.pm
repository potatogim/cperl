...
$bits{$_}{3} = 'OPpENTERSUB_AMPER' for qw(enterffi entersub enterxssub rv2cv);
$bits{$_}{6} = 'OPpENTERSUB_DB' for qw(enterffi entersub enterxssub rv2cv);
$bits{$_}{2} = 'OPpENTERSUB_HASTARG' for qw(enterffi entersub enterxssub rv2cv);
$bits{$_}{0} = 'OPpENTERSUB_INARGS' for qw(enterffi entersub enterxssub);
...
$bits{$_}{1} = 'OPpHINT_STRICT_REFS' for qw(enterffi entersub enterxssub multideref rv2av rv2cv rv2gv rv2hv rv2sv);
...
$bits{$_}{7} = 'OPpLVAL_INTRO' for qw(aelem aslice cond_expr delete enterffi enteriter entersub enterxssub gvsv helem hslice list lvavref lvref lvrefslice multideref oelem padav padhv padrange padsv pushmark refassign rv2av rv2gv rv2hv rv2sv split);
...
$bits{$_}{4} = 'OPpTARGET_MY' for qw(abs add atan2 chdir chmod chomp chown chr chroot concat cos crypt divide exec exp flock getpgrp getppid getpriority hex i_add i_bit_and i_bit_or i_bit_xor i_complement i_divide i_modulo i_multiply i_pow i_subtract index int kill left_shift length link log match mkdir modulo multiply oct ord pow push qr rand rename right_shift rindex rmdir s_complement schomp setpgrp setpriority sin sleep sqrt srand stringify subst subtract symlink system time trans transr u_add u_multiply u_subtract unlink unshift utime wait waitpid);
...
our %ops_using = (
    ...
    OPpEARLY_CV              => [qw(gv)],
    OPpENTERSUB_AMPER        => [qw(enterffi entersub enterxssub rv2cv)],
    OPpENTERSUB_INARGS       => [qw(enterffi entersub enterxssub)],
    ...
    OPpHINT_STRICT_REFS      => [qw(enterffi entersub enterxssub multideref rv2av rv2cv rv2gv rv2hv rv2sv)],
    ...
    OPpLVAL_INTRO            => [qw(aelem aslice cond_expr delete enterffi enteriter entersub enterxssub gvsv helem hslice list lvavref lvref lvrefslice multideref oelem padav padhv padrange padsv pushmark refassign rv2av rv2gv rv2hv rv2sv split)],
