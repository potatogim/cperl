...
$bits{$_}{7} = 'OPpLVAL_INTRO' for qw(aelem aslice cond_expr delete enteriter entersub enterxssub gvsv helem hslice list lvavref lvref lvrefslice multideref oelem padav padhv padrange padsv pushmark refassign rv2av rv2gv rv2hv rv2sv split);
...
$bits{$_}{5} = 'OPpTRUEBOOL' for qw(padhv ref rv2hv typeof);
...
our %ops_using = (
    ...
    OPpLVAL_INTRO            => [qw(aelem aslice cond_expr delete enteriter entersub enterxssub gvsv helem hslice list lvavref lvref lvrefslice multideref oelem padav padhv padrange padsv pushmark refassign rv2av rv2gv rv2hv rv2sv split)],
