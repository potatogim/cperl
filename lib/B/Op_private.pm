...
$bits{$_}{3} = 'OPpBOXRET' for qw(int_abs int_add int_divide int_eq int_ge int_gt int_le int_lt int_modulo int_multiply int_ne int_negate int_not int_padsv int_postdec int_postinc int_predec int_preinc int_subtract num_add num_atan2 num_cos num_divide num_exp num_log num_multiply num_padsv num_pow num_sin num_sqrt num_subtract str_padsv uint_complement uint_left_shift uint_padsv uint_pow uint_right_shift);
$bits{$_}{4} = 'OPpCONST_ENTERED' for qw(const int_const num_const str_const uint_const);
$bits{$_}{1} = 'OPpCONST_NOVER' for qw(const int_const num_const str_const uint_const);
$bits{$_}{2} = 'OPpCONST_SHORTCIRCUIT' for qw(const int_const num_const str_const uint_const);
$bits{$_}{3} = 'OPpCONST_STRICT' for qw(const int_const num_const str_const uint_const);
$bits{$_}{6} = 'OPpCONST_UNBOXED' for qw(int_const num_const str_const uint_const);
...
$bits{$_}{4} = 'OPpHASHPAIRS' for qw(mapwhile padav rv2av);
...
$bits{$_}{7} = 'OPpLVAL_INTRO' for qw(aelem aslice cond_expr delete enteriter entersub enterxssub gvsv helem hslice int_padsv list lvavref lvref lvrefslice multideref num_padsv oelem padav padhv padrange padsv pushmark refassign rv2av rv2gv rv2hv rv2sv split str_padsv uint_padsv);
$bits{$_}{2} = 'OPpLVREF_ELEM' for qw(lvref refassign);
$bits{$_}{3} = 'OPpLVREF_ITER' for qw(lvref refassign);
$bits{$_}{3} = 'OPpMAYBE_LVSUB' for qw(aassign aelem aelem_u akeys aslice av2arylen avhvswitch helem hslice keys kvaslice kvhslice multideref oelem padav padhv pos rv2av rv2gv rv2hv substr vec);
...
$bits{$_}{6} = 'OPpPAD_NATIVE' for qw(int_padsv num_padsv str_padsv uint_padsv);
...
$bits{$_}{4} = 'OPpTARGET_MY' for qw(abs add atan2 chdir chmod chomp chown chr chroot concat cos crypt divide exec exp flock getpgrp getppid getpriority hex i_add i_bit_and i_bit_or i_bit_xor i_complement i_divide i_modulo i_multiply i_pow i_subtract index int int_abs int_add int_divide int_modulo int_multiply int_subtract kill left_shift length link log match mkdir modulo multiply num_add num_atan2 num_cos num_divide num_exp num_log num_multiply num_pow num_sin num_sqrt num_subtract oct ord pow push qr rand rename right_shift rindex rmdir s_complement schomp setpgrp setpriority sin sleep sqrt srand stringify subst subtract symlink system time trans transr u_add u_multiply u_subtract uint_left_shift uint_pow uint_right_shift unlink unshift utime wait waitpid);
...
@{$bits{aelemfast_lex_u}}{7,6,5,4,3,2,1,0} = ($bf[6], $bf[6], $bf[6], $bf[6], $bf[6], $bf[6], $bf[6], $bf[6]);
$bits{akeys}{0} = $bf[0];
$bits{alarm}{0} = $bf[0];
$bits{and}{0} = $bf[0];
...
$bits{int}{0} = $bf[0];
$bits{int_abs}{0} = $bf[0];
@{$bits{int_add}}{1,0} = ($bf[1], $bf[1]);
@{$bits{int_aelem}}{1,0} = ($bf[1], $bf[1]);
@{$bits{int_aelem_u}}{1,0} = ($bf[1], $bf[1]);
@{$bits{int_divide}}{1,0} = ($bf[1], $bf[1]);
@{$bits{int_eq}}{1,0} = ($bf[1], $bf[1]);
@{$bits{int_ge}}{1,0} = ($bf[1], $bf[1]);
@{$bits{int_gt}}{1,0} = ($bf[1], $bf[1]);
@{$bits{int_le}}{1,0} = ($bf[1], $bf[1]);
@{$bits{int_lt}}{1,0} = ($bf[1], $bf[1]);
@{$bits{int_modulo}}{1,0} = ($bf[1], $bf[1]);
@{$bits{int_multiply}}{1,0} = ($bf[1], $bf[1]);
@{$bits{int_ne}}{1,0} = ($bf[1], $bf[1]);
$bits{int_negate}{0} = $bf[0];
$bits{int_not}{0} = $bf[0];
@{$bits{int_padsv}}{5,4} = ($bf[7], $bf[7]);
$bits{int_postdec}{0} = $bf[0];
$bits{int_postinc}{0} = $bf[0];
$bits{int_predec}{0} = $bf[0];
$bits{int_preinc}{0} = $bf[0];
@{$bits{int_sassign}}{1,0} = ($bf[1], $bf[1]);
@{$bits{int_subtract}}{1,0} = ($bf[1], $bf[1]);
...
@{$bits{length}}{6,5,0} = ('OPpLENGTH_TRUEBOOL', 'OPpLENGTH_MAYBE_TRUEBOOL', $bf[0]);
...
@{$bits{mapwhile}}{2,0} = ('OPpMAP_HASH', $bf[0]);
$bits{method}{0} = $bf[0];
...
$bits{next}{0} = $bf[0];
$bits{not}{0} = $bf[0];
@{$bits{num_add}}{1,0} = ($bf[1], $bf[1]);
@{$bits{num_aelem}}{1,0} = ($bf[1], $bf[1]);
@{$bits{num_aelem_u}}{1,0} = ($bf[1], $bf[1]);
@{$bits{num_atan2}}{1,0} = ($bf[1], $bf[1]);
$bits{num_cos}{0} = $bf[0];
@{$bits{num_divide}}{1,0} = ($bf[1], $bf[1]);
$bits{num_exp}{0} = $bf[0];
$bits{num_log}{0} = $bf[0];
@{$bits{num_multiply}}{1,0} = ($bf[1], $bf[1]);
@{$bits{num_padsv}}{5,4} = ($bf[7], $bf[7]);
@{$bits{num_pow}}{1,0} = ($bf[1], $bf[1]);
@{$bits{num_sassign}}{1,0} = ($bf[1], $bf[1]);
$bits{num_sin}{0} = $bf[0];
$bits{num_sqrt}{0} = $bf[0];
@{$bits{num_subtract}}{1,0} = ($bf[1], $bf[1]);
$bits{oct}{0} = $bf[0];
$bits{oelem}{0} = $bf[0];
@{$bits{oelemfast}}{7,6,5,4,3,2,1,0} = ($bf[6], $bf[6], $bf[6], $bf[6], $bf[6], $bf[6], $bf[6], $bf[6]);
$bits{once}{0} = $bf[0];
...
$bits{rv2hv}{0} = $bf[0];
@{$bits{rv2sv}}{5,4,2,0} = ($bf[7], $bf[7], 'OPpHINT_STRICT_NAMES', $bf[0]);
...
@{$bits{sassign}}{7,6,5,1,0} = ('OPpASSIGN_CV_TO_GV', 'OPpASSIGN_BACKWARDS', 'OPpASSIGN_CONSTINIT', $bf[1], $bf[1]);
$bits{scalar}{0} = $bf[0];
$bits{schomp}{0} = $bf[0];
$bits{schop}{0} = $bf[0];
...
$bits{stat}{0} = $bf[0];
@{$bits{str_aelem}}{1,0} = ($bf[1], $bf[1]);
@{$bits{str_aelem_u}}{1,0} = ($bf[1], $bf[1]);
@{$bits{str_padsv}}{5,4} = ($bf[7], $bf[7]);
@{$bits{str_sassign}}{1,0} = ($bf[1], $bf[1]);
...
our %labels = (
    ...
    OPpGREP_LEX              => 'GREPLEX',
    OPpHASHPAIRS             => 'HASHPAIRS',
    OPpHINT_STRICT_NAMES     => 'NAMES',
...
our %ops_using = (
    ...
    OPpBOXRET                => [qw(int_abs int_add int_divide int_eq int_ge int_gt int_le int_lt int_modulo int_multiply int_ne int_negate int_not int_padsv int_postdec int_postinc int_predec int_preinc int_subtract num_add num_atan2 num_cos num_divide num_exp num_log num_multiply num_padsv num_pow num_sin num_sqrt num_subtract str_padsv uint_complement uint_left_shift uint_padsv uint_pow uint_right_shift)],
    OPpCONST_BARE            => [qw(const)],
    OPpCONST_ENTERED         => [qw(const int_const num_const str_const uint_const)],
    OPpCONST_UNBOXED         => [qw(int_const num_const str_const uint_const)],
    ...
    OPpHASHPAIRS             => [qw(mapwhile padav rv2av)],
    OPpHINT_STRICT_NAMES     => [qw(rv2sv)],
    ...
    OPpLVAL_INTRO            => [qw(aelem aslice cond_expr delete enteriter entersub enterxssub gvsv helem hslice int_padsv list lvavref lvref lvrefslice multideref num_padsv oelem padav padhv padrange padsv pushmark refassign rv2av rv2gv rv2hv rv2sv split str_padsv uint_padsv)],
    OPpLVREF_ELEM            => [qw(lvref refassign)],
    OPpMAP_HASH              => [qw(mapwhile)],
    OPpMAYBE_LVSUB           => [qw(aassign aelem aelem_u akeys aslice av2arylen avhvswitch helem hslice keys kvaslice kvhslice multideref oelem padav padhv pos rv2av rv2gv rv2hv substr vec)],
    ...
    OPpPAD_NATIVE            => [qw(int_padsv num_padsv str_padsv uint_padsv)],
    ...
    OPpTARGET_MY             => [qw(abs add atan2 chdir chmod chomp chown chr chroot concat cos crypt divide exec exp flock getpgrp getppid getpriority hex i_add i_bit_and i_bit_or i_bit_xor i_complement i_divide i_modulo i_multiply i_pow i_subtract index int int_abs int_add int_divide int_modulo int_multiply int_subtract kill left_shift length link log match mkdir modulo multiply num_add num_atan2 num_cos num_divide num_exp num_log num_multiply num_pow num_sin num_sqrt num_subtract oct ord pow push qr rand rename right_shift rindex rmdir s_complement schomp setpgrp setpriority sin sleep sqrt srand stringify subst subtract symlink system time trans transr u_add u_multiply u_subtract uint_left_shift uint_pow uint_right_shift unlink unshift utime wait waitpid)],
...
$ops_using{OPpASSIGN_CONSTINIT} = $ops_using{OPpASSIGN_BACKWARDS};
$ops_using{OPpASSIGN_CV_TO_GV} = $ops_using{OPpASSIGN_BACKWARDS};
$ops_using{OPpCONST_NOVER} = $ops_using{OPpCONST_ENTERED};
$ops_using{OPpCONST_SHORTCIRCUIT} = $ops_using{OPpCONST_ENTERED};
$ops_using{OPpCONST_STRICT} = $ops_using{OPpCONST_ENTERED};
...
$ops_using{OPpLENGTH_TRUEBOOL} = $ops_using{OPpLENGTH_MAYBE_TRUEBOOL};
