...
#define SVs_PADSTALE	U32_CONST(0x00040000)  /* lexical has gone out of scope;
 ...
 */
#define SVf_AMAGIC	U32_CONST(0x10000000)  /* has magical overloaded methods */
#define SVf_IsCOW	U32_CONST(0x10000000)  /* copy on write (shared hash key if
				       SvLEN == 0) */
...
#define SVf_UTF8        U32_CONST(0x20000000)  /* SvPV is UTF-8 encoded
				       This is also set on RVs whose overloaded
				       stringification is UTF-8. This might
				       only happen as a side effect of SvPV() */
/* PVHV */
#define SVphv_SHAREKEYS U32_CONST(0x20000000)  /* PVHV keys live on shared string table */
...
#define SVpav_SHAPED    U32_CONST(0x20000000)  /* PVAV with declared size */

/* Some private flags. */


/* PVAV */
#define SVpav_REAL	U32_CONST(0x40000000)  /* free old entries. handle refcounts of array elements */
/* PVHV */
#define SVphv_LAZYDEL	U32_CONST(0x40000000)  /* entry in xhv_eiter must be deleted */

/* IV, PVIV, PVNV, PVMG, PVGV and (I assume) PVLV  */
#define SVf_IVisUV	U32_CONST(0x80000000)  /* use XPVUV instead of XPVIV */
/* PVAV */
#define SVpav_REIFY 	U32_CONST(0x80000000)  /* elements can become real ($_[] => SV) */
/* PVHV */
#define SVphv_HASKFLAGS	U32_CONST(0x80000000)  /* keys have flag byte after hash */
/* RV upwards. However, SVf_ROK and SVp_IOK are exclusive  */
#define SVprv_WEAKREF   U32_CONST(0x80000000)  /* Weak reference */
/* pad name vars only */
